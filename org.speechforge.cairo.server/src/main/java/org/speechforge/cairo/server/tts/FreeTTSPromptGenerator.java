 ...
 */
public class FreeTTSPromptGenerator extends AbstractPoolableObject implements PromptGenerator {
    /** Logger instance. */
    private static final Logger LOGGER = 
            LogManager.getLogger(FreeTTSPromptGenerator.class);

    private Voice _voice;

    public FreeTTSPromptGenerator(String voiceName) {
