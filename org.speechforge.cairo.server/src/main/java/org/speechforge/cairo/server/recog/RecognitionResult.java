...
public class RecognitionResult {
    ...
    /**
     * TODOC
     * @param textResult the result
     * @param ruleGrammar the rule grammar to use to parse text
     * @throws NullPointerException error initializing 
     */
    ...
    /**
     * TODOC
     * @param inputString String representation of this object (generated by the toString() method)
     * @return RecognitionResult the result
