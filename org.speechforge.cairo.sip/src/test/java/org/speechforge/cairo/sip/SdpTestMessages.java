...
public class SdpTestMessages {
    ...
    public static final String INVITE_REQUEST_4 = "v=0\n"
            + "o=dirk-jitsi.org 0 0 IN IP4 192.168.71.1\n"
            + "s=-\n"
            + "c=IN IP4 192.168.71.1\n"
            + "t=0 0\n"
            ...
            + "a=imageattr:105 send * recv [x=[1:3840],y=[1:2160]]\n"
            + "a=rtpmap:99 H264/90000\n"
            + "a=fmtp:99 profile-level-id=4DE01f\n"
            + "a=imageattr:99 send * recv [x=[1:3840],y=[1:2160]]";
